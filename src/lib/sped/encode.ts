/**
 * Codificação de bytes e validação de recibo — puro, sem DOM. Compartilhado
 * entre a thread principal e o Web Worker (ver spedWorker.ts): o worker não
 * tem acesso a `document`/`URL.createObjectURL`+link, só a esse pedaço.
 */
